...
public class PersonalInfoActivity extends Activity {
    ...
    public void initData()
    {
        ...
        //设置头像
        iv_photohead.setImageURI(Uri.fromFile(new File(StaticValues.USER_HEADPATH+ClientManger.ClientPhone+".png")));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //选择医生
        rl_doctor=(RelativeLayout)findViewById(R.id.personal_rl_p2p1);
        rl_doctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PersonalInfoActivity.this,ChooseDoctorActivity.class);
                startActivity(intent);
            }
        });

        MainActivity.myBinder.Getdoctorlist();//发送请求去获取结果
