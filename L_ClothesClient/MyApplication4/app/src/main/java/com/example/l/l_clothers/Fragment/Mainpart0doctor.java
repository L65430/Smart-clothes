...
//消息界面
public class Mainpart0doctor extends Fragment implements ChatListViewAdapter.RemoveListener,SlideCutListView.OnItemLongClickListener,SlideCutListView.OnItemClickListener{
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_main_part0_doctor, container, false);
    ...
    private void init() {
        ...
        slideCutListView = (SlideCutListView) view
                .findViewById(R.id.fra_p0_listview_doctor);
                    ...
                    protected Void doInBackground(Void... params) {
                        try {
                            ...
                            if (!ClientManger.isOnline) {
                                MainDoctorActivity.myBinder.ConnectServer();
