 ...
 */
public class Mainpart3doctor extends android.app.Fragment {
    View view;
...
//    RelativeLayout r1_personalsetting;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_main_part3_doctor, container, false);
...
//        });
    ...
    public void clearAllMsg() {
        ...
        List<String> friendIds = MainDoctorActivity.mp0friend.getFriendsIds();//这个还不好说，具体要怎么搞
        if (friendIds.size() > 0) {
    ...
    public void clearLatice()
    {
        myDialog dialog = new myDialog(context, "清空中...");
        dialog.show();
        MainDoctorActivity.mp0talk.clearrecent();
        dialog.dismiss();
        Toast.makeText(context, "清空完成", Toast.LENGTH_LONG).show();
    }
